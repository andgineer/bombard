...
def expand_relative_file_name(file_name):
    ...
    """
    if file_name.lower().strip().startswith(EXAMPLES_PREFIX):
...
def get_args():
    parser = argparse.ArgumentParser(
        ...
        epilog=f'''See examples of requests files (yaml or py) on https://github.com/masterandrey/bombard.
To use example prefix it with '{EXAMPLES_PREFIX}' like
    bombard {EXAMPLES_PREFIX}simple.yaml
'''
    )
    parser.add_argument(
